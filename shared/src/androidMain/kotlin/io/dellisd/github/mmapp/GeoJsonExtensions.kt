...
fun Feature.toMapbox(): MapboxFeature {
    ...
    properties.forEach { (key, value) ->
        when {
            ...
            value.jsonPrimitive.booleanOrNull != null -> props.addProperty(key, value.jsonPrimitive.boolean)
            value.jsonPrimitive.contentOrNull != null -> props.addProperty(key, value.jsonPrimitive.content)
            value.jsonPrimitive.doubleOrNull != null -> props.addProperty(key, value.jsonPrimitive.double)
            value.jsonPrimitive.longOrNull != null -> props.addProperty(key, value.jsonPrimitive.long)
            value.jsonPrimitive.floatOrNull != null -> props.addProperty(key, value.jsonPrimitive.float)
